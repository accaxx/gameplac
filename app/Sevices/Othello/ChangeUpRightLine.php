...
class ChangeUpRightLine extends BaseChangeLine
{
     ...
     * @return bool
     */
    public function changeUpRight()
    {
        if (!$this->isChangeUpRight()) {
            return false;
        }
        ...
        for ($i = 2; $this->key_digit_two + $i <= 8, $this->key_digit_one - $i > 0; $i++) {
            ...
            if ($this->key_digit_two + $i === 8 || $this->key_digit_one - $i === 1) {
     ...
     * @return bool
     */
    private function isChangeUpRight()
    {
        if ($this->key_digit_two >= 7 || $this->key_digit_one <= 2) {
            return false;
        }
