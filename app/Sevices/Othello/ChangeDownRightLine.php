...
class ChangeDownRightLine extends BaseChangeLine
{
     ...
     * @return bool
     */
    public function changeDownRight()
    {
        if (!$this->isChangeDownRight()) {
            return false;
        }
        ...
        for ($i = 2; $this->key_digit_two - $i > 0, $this->key_digit_one - $i > 0; $i++) {
            ...
            if ($this->key_digit_two - $i <= 1 || $this->key_digit_one <= 1) {
     ...
     * @return bool
     */
    private function isChangeDownRight()
    {
        if ($this->key_digit_two <= 2 || $this->key_digit_one <= 2) {
            return false;
        }
