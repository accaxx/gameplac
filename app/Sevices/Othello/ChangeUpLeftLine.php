...
class ChangeUpLeftLine extends BaseChangeLine
{
     ...
     * @return bool
     */
    public function changeUpLeft()
    {
        if (!$this->isChangeUpLeft()) {
            return false;
        }
        ...
        for ($i = 2; $this->key_digit_two + $i <= 8, $this->key_digit_one + $i <= 8; $i++) {
            ...
            if ($this->key_digit_two === 8 || $this->key_digit_one === 8) {
     ...
     * @return bool
     */
    private function isChangeUpLeft()
    {
        if ($this->key_digit_two >= 7 || $this->key_digit_one >= 7) {
            return false;
        }
